...
sudo curl -L "https://raw.githubusercontent.com/CeciFan/azure-quickstart-templates/master/application-workloads/opendx/openedx-tutor-lilac-ubuntu/script/deploy_tutor.sh" -o /usr/local/deploy_tutor.sh
